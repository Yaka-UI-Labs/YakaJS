...
return new t(void 0!==n?n:[])},text(e){return void 0===e?this.elements[0]?.textContent||"":this.each((t,n)=>n.textContent=e)},html(e,n=!1){return void 0===e?this.elements[0]?.innerHTML||"":this.each((r,o)=>{if(n&&t.security&&"function"==typeof t.security.sanitizeHtml)o.innerHTML=t.security.sanitizeHtml(e)
else if(n){const t=document.createElement("div")
t.textContent=e,o.innerHTML=t.innerHTML}else o.innerHTML=e})},val(e){return void 0===e?this.elements[0]?.value||"":this.each((t,n)=>n.value=e)},attr(e,t){if("object"==typeof e){const t=Object.keys(e)
...
return 3===t.length?{r:parseInt(t[0]+t[0],16),g:parseInt(t[1]+t[1],16),b:parseInt(t[2]+t[2],16),a:1}:{r:parseInt(t.substring(0,2),16),g:parseInt(t.substring(2,4),16),b:parseInt(t.substring(4,6),16),a:1}}if(e.startsWith("rgb")){const t=e.match(/(\d+(?:\.\d+)?)/g)
return t?{r:+t[0],g:+t[1],b:+t[2],a:void 0!==t[3]?+t[3]:1}:null}return null},s=["color","backgroundColor","borderColor"]
