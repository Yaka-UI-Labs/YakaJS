...
return new t(void 0!==n?n:[])},text(e){return void 0===e?this.elements[0]?.textContent||"":this.each((t,n)=>n.textContent=e)},html(e,n=!1){return void 0===e?this.elements[0]?.innerHTML||"":this.each((r,o)=>{o.innerHTML=n?t.security.sanitizeHtml(e):e})},val(e){return void 0===e?this.elements[0]?.value||"":this.each((t,n)=>n.value=e)},attr(e,t){if("object"==typeof e){const t=Object.keys(e)
...
return 3===t.length?{r:parseInt(t[0]+t[0],16),g:parseInt(t[1]+t[1],16),b:parseInt(t[2]+t[2],16),a:1}:{r:parseInt(t.substring(0,2),16),g:parseInt(t.substring(2,4),16),b:parseInt(t.substring(4,6),16),a:1}}if(e.startsWith("rgb")){const t=e.match(/[\d.]+/g)
