...
if(t.prototype={constructor:t,each(e){return this.elements.forEach((t,n)=>{e.call(t,n,t)}),this},get(e){return void 0===e?this.elements:this.elements[e]},first(){return new t(this.elements[0])},last(){return new t(this.elements[this.elements.length-1])},eq(e){return new t(this.elements[e])},text(e){return void 0===e?this.elements[0]?.textContent||"":this.each((t,n)=>n.textContent=e)},html(e){return void 0===e?this.elements[0]?.innerHTML||"":this.each((t,n)=>n.innerHTML=e)},val(e){return void 0===e?this.elements[0]?.value||"":this.each((t,n)=>n.value=e)},attr(e,t){return"object"==typeof e?this.each((t,n)=>{Object.keys(e).forEach(t=>n.setAttribute(t,e[t]))}):void 0===t?this.elements[0]?.getAttribute(e):this.each((n,r)=>r.setAttribute(e,t))},removeAttr(e){return this.each((t,n)=>n.removeAttribute(e))},data(e,t){return void 0===t?this.elements[0]?.dataset[e]:this.each((n,r)=>r.dataset[e]=t)},addClass(e,t){return this.each(t?(n,r)=>{const o=e.split(" "),a={},s=getComputedStyle(r);["opacity","height","width","margin","padding"].forEach(e=>{a[e]=s[e]}),o.forEach(e=>r.classList.add(e))
const i=getComputedStyle(r),l=[]
Object.keys(a).forEach(e=>{a[e]!==i[e]&&l.push(`${e} ${t}ms ease`)}),l.length>0&&(r.style.transition=l.join(", "),setTimeout(()=>r.style.transition="",t))}:(t,n)=>{e.split(" ").forEach(e=>n.classList.add(e))})},removeClass(e,t){return e?this.each(t?(n,r)=>{const o=e.split(" "),a={},s=getComputedStyle(r);["opacity","height","width","margin","padding"].forEach(e=>{a[e]=s[e]}),o.forEach(e=>r.classList.remove(e))
const i=getComputedStyle(r),l=[]
Object.keys(a).forEach(e=>{a[e]!==i[e]&&l.push(`${e} ${t}ms ease`)}),l.length>0&&(r.style.transition=l.join(", "),setTimeout(()=>r.style.transition="",t))}:(t,n)=>{e.split(" ").forEach(e=>n.classList.remove(e))}):(console.warn("removeClass() with no arguments is deprecated. Use detach() to remove element from DOM."),this.each((e,t)=>t.remove()))},toggleClass(e,n){return this.each(n?(r,o)=>{const a=o.classList.contains(e),s=new t(o)
...
return 3===t.length?{r:parseInt(t[0]+t[0],16),g:parseInt(t[1]+t[1],16),b:parseInt(t[2]+t[2],16)}:{r:parseInt(t.substring(0,2),16),g:parseInt(t.substring(2,4),16),b:parseInt(t.substring(4,6),16)}}if(e.startsWith("rgb")){const t=e.match(/\d+/g)
return{r:+t[0],g:+t[1],b:+t[2]}}return null},s=["color","backgroundColor","borderColor"]
...
Object.keys(r).forEach(e=>{r[e]&&i[e]&&(o.style[e]=`rgb(${Math.round(r[e].r+(i[e].r-r[e].r)*n)}, ${Math.round(r[e].g+(i[e].g-r[e].g)*n)}, ${Math.round(r[e].b+(i[e].b-r[e].b)*n)})`)}),1>n&&requestAnimationFrame(c)}
c()
const d={}
...
t._yaka_confetti_timeouts.push(r)}t._yaka_confetti_cleanup||(t._yaka_confetti_cleanup=()=>{t._yaka_confetti_timeouts&&(t._yaka_confetti_timeouts.forEach(e=>clearTimeout(e)),t._yaka_confetti_timeouts=[]),delete t._yaka_confetti_cleanup})})}},t.get=async(e,t)=>{const n=t?"?"+new URLSearchParams(t):""
return(await fetch(e+n)).json()},t.post=async(e,t)=>(await fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),t.put=async(e,t)=>(await fetch(e,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json(),t.delete=async e=>(await fetch(e,{method:"DELETE"})).json(),t.ajax=async e=>{const{url:t,method:n="GET",data:r,headers:o={}}=e,a={method:n,headers:{"Content-Type":"application/json",...o}}
"GET"!==n&&r&&(a.body=JSON.stringify(r))
const s="GET"===n&&r?t+"?"+new URLSearchParams(r):t
return(await fetch(s,a)).json()},t.each=(e,t)=>{Array.isArray(e)?e.forEach(t):Object.keys(e).forEach(n=>t(n,e[n]))},t.map=(e,t)=>e.map(t),t.filter=(e,t)=>e.filter(t),t.ready=e=>{"loading"!==document.readyState?e():document.addEventListener("DOMContentLoaded",e)},t.debounce=function(e,t=300){let n
...
r.setTime(r.getTime()+864e5*n),document.cookie=`${e}=${t};expires=${r.toUTCString()};path=/`},get(e){const t=document.cookie.match(RegExp("(^| )"+e+"=([^;]+)"))
return t?t[2]:null},remove(e){this.set(e,"",-1)}},t.storage={set(e,t){localStorage.setItem(e,JSON.stringify(t))},get(e){const t=localStorage.getItem(e)
try{return JSON.parse(t)}catch{return t}},remove(e){localStorage.removeItem(e)},clear(){localStorage.clear()}},t.prototype.draggable=function(e={}){return this.each((t,n)=>{if(n._yaka_draggable)return
n._yaka_draggable=!0
let r,o,a,s,i=!1
...
let b=h,v=m,x=y,_=f
if(t.includes("e")&&(b=h+c),t.includes("w")&&(b=h-c,x=y+c),t.includes("s")&&(v=m+d),t.includes("n")&&(v=m-d,_=f+d),b=Math.max(o,Math.min(s,b)),v=Math.max(a,Math.min(i,v)),l){const e=h/m
...
const r=new Set
return[()=>(t.signal._currentEffect&&r.add(t.signal._currentEffect),n),e=>{n!==e&&(n="function"==typeof e?e(n):e,t._log("info","Signal updated",{value:n}),r.forEach(e=>e()))}]},t.effect=e=>{const n=()=>{t.signal._currentEffect=n
try{e()}finally{t.signal._currentEffect=null}}
n()},t.computed=e=>{const[n,r]=t.signal(void 0)
return t.effect(()=>r(e())),n},t.detectLeaks=()=>{const e=[]
