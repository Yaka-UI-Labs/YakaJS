...
return new t(void 0!==n?n:[])},text(e){return void 0===e?this.elements[0]?.textContent||"":this.each((t,n)=>n.textContent=e)},html(e){return void 0===e?this.elements[0]?.innerHTML||"":this.each((t,n)=>n.innerHTML=e)},val(e){return void 0===e?this.elements[0]?.value||"":this.each((t,n)=>n.value=e)},attr(e,t){return"object"==typeof e?this.each((t,n)=>{Object.keys(e).forEach(t=>n.setAttribute(t,e[t]))}):void 0===t?this.elements[0]?.getAttribute(e):this.each((n,r)=>r.setAttribute(e,t))},removeAttr(e){return this.each((t,n)=>n.removeAttribute(e))},data(e,t){return void 0===t?this.elements[0]?.dataset[e]:this.each((n,r)=>r.dataset[e]=t)},addClass(e,t){return this.each(t?(n,r)=>{const o=e.split(" "),a={},s=getComputedStyle(r);["opacity","height","width","margin","padding"].forEach(e=>{a[e]=s[e]}),o.forEach(e=>r.classList.add(e))
