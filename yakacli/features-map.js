...
module.exports = {
    ...
    categories: {
        ...
        uiComponents: {
            name: 'UI Components',
            description: 'Modals, tooltips, tabs, accordion, carousel, buttons, checkboxes, menus, selectbox, pickers, etc.',
            modules: [
                'modal',
                'notifications',
                'toast',
        ...
        advanced: {
            ...
            description: 'Drag & drop, resizable, droppable, selectable, sortable, gestures, position utility, fullpage scrolling, web workers',
            modules: [
                'draggable',
                'resizable',
                'droppable',
    ...
    modules: {
        ...
        // UI COMPONENTS
        'modal': { start: 2030, end: 2105, category: 'uiComponents' },
        'notifications': { start: 1732, end: 1762, category: 'uiComponents' },
        'toast': { start: 1764, end: 1864, category: 'uiComponents' },
        'alerts': { start: 1866, end: 2027, category: 'uiComponents' },
        'tooltips': { start: 2107, end: 2166, category: 'uiComponents' },
        'button': { start: 2168, end: 2280, category: 'uiComponents' },
        'checkboxradio': { start: 2282, end: 2363, category: 'uiComponents' },
        'controlgroup': { start: 2365, end: 2418, category: 'uiComponents' },
        'menu': { start: 2420, end: 2513, category: 'uiComponents' },
        'selectbox': { start: 2484, end: 2670, category: 'uiComponents' },
        'tabs': { start: 3034, end: 3073, category: 'uiComponents' },
        'accordion': { start: 3075, end: 3107, category: 'uiComponents' },
        'carousel': { start: 3109, end: 3155, category: 'uiComponents' },
        'color-picker': { start: 2957, end: 2985, category: 'uiComponents' },
        'date-picker': { start: 2987, end: 3012, category: 'uiComponents' },
        'time-picker': { start: 2672, end: 2793, category: 'uiComponents' },
        'slider': { start: 3014, end: 3048, category: 'uiComponents' },
        'autocomplete': { start: 3264, end: 3355, category: 'uiComponents' },
        'data-table': { start: 3171, end: 3254, category: 'uiComponents' },
        ...
        'position-utility': { start: 4301, end: 4403, category: 'advanced' },
        'fullpage-scrolling': { start: 2795, end: 2903, category: 'advanced' },
